...
export default function Hero() {
  return <header id="top" className="grid-lines relative min-h-screen overflow-hidden border-b border-black/10 px-5 pb-10 pt-28 md:px-8">
    <div className="mx-auto grid min-h-[80vh] max-w-[1500px] grid-cols-12 items-end gap-4">
      ...
      <div className="col-span-12 relative mt-10 h-64 overflow-hidden md:col-span-4 md:mb-12 md:h-[52vh]">
        <Image src="https://media.base44.com/images/public/6a899874b9c9c8d903d80a8c/106bd5c7f_generated_3766af80.png" alt="Macro view of a precision processor and circuit traces" className="h-full w-full grayscale transition duration-700 hover:scale-105 hover:grayscale-0" />
        <span className="absolute bottom-3 left-3 bg-white px-2 py-1 font-mono text-[10px]">ARTIFACT / STOCKPRO</span>
      </div>
    </div>
  </header>;
}